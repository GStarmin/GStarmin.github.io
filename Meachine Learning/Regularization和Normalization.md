...
- Regularization：为了使函数曲线更平滑
  ...
  - 常用方法：可以在Lost function的高次系数增加一个惩罚项————一个很大的系数，这样就可以使高次的参数尽可能小。但是在实际应用中我们常常不知道去最小化哪一个参数，所以就修改lost function来尽可能最小化所有的参数。做法是增加惩罚项所有参数的平方和（这种方法也叫L2正则化，2因为是所有参数的平方，当然也有L1正则化，只不过一般来说效果没有L2正则化效果好）
